...
exports.getFinancialEvolutionSchema = exports.getDahBoardSchema = exports.indexTransactionSchema = exports.createTransactionSchema = void 0;
...
exports.getDahBoardSchema = {
    beginDate: zod_1.z.coerce.date().optional(),
    endDate: zod_1.z.coerce.date().optional(),
};
const getDashboardObject = zod_1.z.object(exports.getDahBoardSchema);
